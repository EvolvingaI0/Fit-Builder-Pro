...
function Login({ onNavigateToSignUp, onNavigateToHome }: LoginProps) {
        ...
        <div className="w-full md:w-1/2 flex flex-col justify-center items-center p-8 md:p-12 order-2 md:order-1">
          <div className="w-full max-w-md">
            <div className="mb-8 text-center md:text-left">
              <h1 className="text-4xl font-bold text-text-primary">Bem-vindo(a) de volta</h1>
              <p className="text-text-secondary mt-2">Acesse sua conta para continuar sua jornada.</p>
            </div>
            <form onSubmit={handleSubmit} className="space-y-6">
               ...
               <Button type="submit" className="w-full py-3.5 text-lg">Entrar</Button>
            </form>
            <p className="text-center text-sm text-text-secondary mt-8">
                Ainda não tem uma conta? <span onClick={onNavigateToSignUp} className="font-semibold text-primary cursor-pointer hover:underline">Crie uma aqui.</span>
            </p>
